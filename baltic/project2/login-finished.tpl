...
{strip}
	<style>
		...
		body {
			--green: #006b57;
			background: url(layouts/v7/resources/Images/greenCircleBackground.jpg);
	...
	<div class="container-fluid loginPageContainer align-items-center">
		<div class="col">
			<div class="loginDiv widgetHeight">
				<img class="img-responsive user-logo" src="layouts/v7/resources/Images/greenCircleLogo.png">
				<div>
